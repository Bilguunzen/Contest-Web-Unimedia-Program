...
class IosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create io" do
    assert_difference('Io.count') do
      post ios_url, params: { io: { contest_id: @io.contest_id, input: @io.input, output: @io.output } }
    end
  ...
  test "should update io" do
    patch io_url(@io), params: { io: { contest_id: @io.contest_id, input: @io.input, output: @io.output } }
